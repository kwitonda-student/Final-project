...
class PrivateReportScreen extends StatefulWidget {
  ...
  @override
  PrivateReportScreenState createState() => PrivateReportScreenState();
}

class PrivateReportScreenState extends State<PrivateReportScreen> {
  ...
  Future<void> _submit() async {
    ...
    if (mounted) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text('Private report submitted')));
      _name.clear();
      _email.clear();
      _info.clear();
    }
